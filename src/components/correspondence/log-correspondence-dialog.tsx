...
import { logCorrespondence } from "@/lib/actions";
...
export function LogCorrespondenceDialog({ eventId }: LogCorrespondenceDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button><PlusIcon /> Log entry</Button>
      </DialogTrigger>
      <DialogContent>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <DialogHeader>
            ...
            <DialogDescription>
              Record an email, meeting, phone call, or note related to this event.
            </DialogDescription>
          </DialogHeader>
          <FieldGroup>
            <Field>
            ...
            <Field>
              ...
              <Input id="log-subject" name="subject" placeholder="Brief subject line" required />
            </Field>
            <div className="grid grid-cols-2 gap-3">
              <Field>
                <FieldLabel htmlFor="log-contact-name">Contact name</FieldLabel>
                <Input id="log-contact-name" name="contact_name" placeholder="e.g. Ms Carter" required />
              </Field>
              <Field>
            ...
            <Field>
              ...
              <Textarea id="log-body" name="body" rows={4} placeholder="Summarise the correspondence..." required />
            </Field>
          </FieldGroup>
          <DialogFooter>
            <DialogClose asChild>
